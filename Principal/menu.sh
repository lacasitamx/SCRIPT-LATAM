...
speed_test() {
  ...
  wget -O /opt/speed/speedtest raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/speedtest.py &>/dev/null
...
ajuste_in() {
  ...
  pamcrack() { #DESACTIVAR PASS ALFANUMERICO
    ...
    [[ $x = @(n|N) ]] && msg -bar && return
    echo -e ""
    wget -O /etc/pam.d/common-password raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/common-password &>/dev/null
...
chekc_users() {
  ...
  inst_depedencias() {
    ...
    [[ -e "/etc/SCRIPT-LATAM/filespy/check.py" ]] && {
      ...
      cd $HOME
      wget raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/check.py -o /dev/null
    ...
    [[ -e "/etc/SCRIPT-LATAM/filespy/4gcheck.py" ]] && {
      ...
      cd $HOME
      wget raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/4gcheck.py -o /dev/null
    ...
    [[ -e "/bin/check" ]] && {
      ...
      cd $HOME
      wget raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/check -o /dev/null
...
proto_badvpn() {
  ...
  if [[ ! -e /bin/badvpn-udpgw ]]; then
    wget -O /bin/badvpn-udpgw raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/badvpn-udpgw &>/dev/null
...
proto_ptcpover() {
  activar_tcpover() {
    ...
    cd socks
    patch="raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/backsocz.zip"
    arq="backsocz.zip"
...
proto_slowndns() {
  ...
  ini_slow() {
    ...
    if [[ ! -e ${SlowDNSinstall}/dns-server ]]; then
      ...
      if wget -O ${SlowDNSinstall}/dns-server raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/dns-server &>/dev/null; then
...
control_v2ray() {
  ...
  intallv2ray() {
    ...
    msg -bar
    source <(curl -sL raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/v2ray.sh)
    v2ray update
...
actulizar_fun() {
  clear && clear
  actu_fun() {
    v1=$(curl -sSL "raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/Version")
    echo "$v1" >/etc/SCRIPT-LATAM/temp/version_instalacion
    wget -O /etc/SCRIPT-LATAM/menu.sh raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Principal/menu.sh &>/dev/null
    chmod +rwx /etc/SCRIPT-LATAM/menu.sh
    wget -O /bin/rebootnb raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/rebootnb.sh &>/dev/null
  ...
  registro=$(curl -sSL "raw.github.com/lacasitamx/SCRIPT-LATAM/Netvps/Fixs-Remotos/cambios")
  echo -ne "$registro"
  echo ""
